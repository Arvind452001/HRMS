  ...
  const handleDelete = async (id, employeeName) => {
    if (window.confirm(`Delete salary structure for ${employeeName}?`)) {
      try {
        ...
        loadSalaries(); // refresh list after delete
      } catch (error) {
  ...
  return (
    <div className="w-full min-h-screen bg-[#f7f5fb] p-4 md:p-6">
      ...
      <div className="overflow-hidden rounded-2xl border border-purple-100 bg-white shadow-sm">
                ...
                currentData.map((salary, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      {/* EMP CODE */}
                      <td className="px-2 py-3">
                        <span className="px-4 py-3 rounded-full bg-purple-100 text-purple-700 text-xs font-semibold">
                      ...
                      {/* NET SALARY */}
                      <td className="px-2 py-3">
                        <span className="px-4 py-3 rounded-full bg-linear-to-r from-indigo-600 via-purple-600 to-pink-600 text-white text-sm font-bold shadow-sm">
                      ...
                      <td className="px-2 py-3">
                        <div className="flex items-center gap-3">
                          ...
                          <button
                            ...
                            className="tooltip tooltip-top w-9 h-9 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white flex items-center justify-center shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200"
                            data-tip="View"
                            aria-label="View"
                          >
                            <FaEye size={14} />
                          ...
                          <button
                            ...
                            className="tooltip tooltip-top w-9 h-9 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-white flex items-center justify-center shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200"
                            data-tip="Edit"
                            aria-label="Edit"
                          >
                            <FaEdit size={14} />
                          ...
                          <button
                            ...
                            className="tooltip tooltip-top w-9 h-9 rounded-xl bg-gradient-to-r from-rose-500 to-red-600 text-white flex items-center justify-center shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200"
                            data-tip="Delete"
                            aria-label="Delete"
                          >
                            <FaTrash size={14} />
        ...
        {/* ================= PAGINATION ================= */}
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 px-2 py-3 border-t border-purple-100 bg-[#faf9fc]">
